...
class ZahtevekAnalizaCreateView(TemplateView):
    template_name = "zahtevki/zahtevek/create_analiza.html"

    def get_context_data(self, *args, **kwargs):
        context = super(ZahtevekAnalizaCreateView, self).get_context_data(*args, **kwargs)
        context['zahtevek_splosno_form'] = ZahtevekCreateForm
        # context['zahtevek_sestanek_form'] = ZahtevekSestanekCreateForm

        modul_zavihek = Zavihek.objects.get(oznaka="ZAHTEVEK_ANALIZA_CREATE")
...
class PodzahtevekAnalizaCreateView(UpdateView):
    model = Zahtevek
    fields = ('id', )
    template_name = "zahtevki/zahtevek/create_analiza.html"

    def get_context_data(self, *args, **kwargs):
        context = super(PodzahtevekAnalizaCreateView, self).get_context_data(*args, **kwargs)
        context['zahtevek_splosno_form'] = ZahtevekCreateForm
        # context['zahtevek_sestanek_form'] = ZahtevekSestanekCreateForm

        modul_zavihek = Zavihek.objects.get(oznaka="PODZAHTEVEK_ANALIZA_CREATE")
        context['modul_zavihek'] = modul_zavihek
