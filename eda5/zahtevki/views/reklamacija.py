...
class ZahtevekReklamacijaCreateView(TemplateView):
    template_name = "zahtevki/zahtevek/create_reklamacija.html"

    def get_context_data(self, *args, **kwargs):
        context = super(ZahtevekReklamacijaCreateView, self).get_context_data(*args, **kwargs)
        context['zahtevek_splosno_form'] = ZahtevekCreateForm
        # context['zahtevek_sestanek_form'] = ZahtevekSestanekCreateForm

        modul_zavihek = Zavihek.objects.get(oznaka="ZAHTEVEK_REKLAMACIJA_CREATE")
...
class PodzahtevekReklamacijaCreateView(UpdateView):
    model = Zahtevek
    fields = ('id', )
    template_name = "zahtevki/zahtevek/create_analiza.html"

    def get_context_data(self, *args, **kwargs):
        context = super(PodzahtevekReklamacijaCreateView, self).get_context_data(*args, **kwargs)
        context['zahtevek_splosno_form'] = ZahtevekCreateForm
        # context['zahtevek_sestanek_form'] = ZahtevekSestanekCreateForm

        modul_zavihek = Zavihek.objects.get(oznaka="PODZAHTEVEK_REKLAMACIJA_CREATE")
        context['modul_zavihek'] = modul_zavihek
