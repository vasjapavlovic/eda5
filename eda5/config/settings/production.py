...
ALLOWED_HOSTS = env.list('DJANGO_ALLOWED_HOSTS', default=['eda5.si'])
...
DEFAULT_FROM_EMAIL = env('DJANGO_DEFAULT_FROM_EMAIL',
                         default='EDA5 Project <noreply@eda5.si>')
EMAIL_BACKEND = 'django_mailgun.MailgunBackend'
MAILGUN_ACCESS_KEY = env('DJANGO_MAILGUN_API_KEY')
MAILGUN_SERVER_NAME = env('DJANGO_MAILGUN_SERVER_NAME')
EMAIL_SUBJECT_PREFIX = env("DJANGO_EMAIL_SUBJECT_PREFIX", default='[EDA5 Project] ')
...
TEMPLATES[0]['OPTIONS']['debug'] = DEBUG  # popraviti
